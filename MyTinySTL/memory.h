...
private:
    ...
    void initialize_buffer(const T& /*unused*/, std::true_type /*unused*/) {}
    void initialize_buffer(const T& value, std::false_type /*unused*/) {
...
public:
    ...
    template <class U>
    explicit auto_ptr(const auto_ptr<U>& rhs) : m_ptr(rhs.release()) {}
